  ...
  describe "posts#index page" do
    ...
    context "when liking a post on the posts#index page" do
      it "increments the likes counter and displays unlike button live using Turbo Streams" do
        ...
        post_likes_frame = find("turbo-frame#post_#{post.id}_likes_index")
        expect(post_likes_frame).to have_content('0')
        ...
        expect(post_likes_frame).to have_content('1')
      end
    end
  end
  ...
  describe "posts#show Modal" do
    ...
    context "when liking a post on the posts#show page" do
      it "increments the likes counter and displays unlike button live using Turbo Streams" do
        ...
        expect(page).to have_button('Like')
        post_likes_frame = find("turbo-frame#post_#{post.id}_likes_show")
        expect(post_likes_frame).to have_content('0')
        ...
        expect(public_likes_show_frame).to have_content('1')
      end
    end
  end
