# This file contains system tests for real-time unread notifications count using Turbo Streams. 
#
...
RSpec.describe "Notifications Count", type: :system, js: true do
  ...
  # These tests are for updating the unread notifications counter for the recipient in real-time using Turbo Streams
  #
  ...
  #
  # Lastly, the expectations for the notification count starting at '0' then incrementing to '1' after a notification is sent
  # and the current path, ensures that the recipient is receiving the updated notifications count in real-time, without a page refresh/reload.
